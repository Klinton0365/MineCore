    ...
    <div className="pt-16">
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-white">About <span className="text-accent-blue">Alkebulan Mining</span></h1>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-primary-light border border-white/10 rounded-xl p-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={branch.code} className="bg-secondary border border-white/10 rounded-xl p-6">
                <span className="text-xs px-2 py-1 rounded bg-accent-blue/10 text-accent-blue border border-accent-blue/30 font-mono">
                  {branch.code}
                </span>
                <h3 className="text-lg font-semibold text-white mt-3">{branch.name}</h3>
                <p className="text-sm text-accent-gold mt-1">{branch.role}</p>
                <p className="text-sm text-text-muted mt-3 leading-relaxed">{branch.desc}</p>
              </div>
            ))}
          </div>
        </div>

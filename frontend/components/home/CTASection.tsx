...
export function CTASection() {
  return (
    <section className="py-20 bg-gradient-to-r from-[var(--color-accent-blue)] to-blue-700">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link href="/products" className="bg-white text-[var(--color-accent-blue)] px-6 py-3 rounded-lg font-medium hover:bg-blue-50 transition-colors">
            Browse Products
          </Link>
